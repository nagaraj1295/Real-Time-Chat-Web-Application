      ...
      <div className="glass-card w-full max-w-5xl rounded-[2.5rem] overflow-hidden grid lg:grid-cols-2 shadow-2xl animate-fade-in transition-all duration-700">
          ...
          <div className="w-full max-w-sm space-y-8">
            ...
            <div className="text-center space-y-3">
              <div className="flex flex-col items-center gap-4 group">
                ...
                <h1 className="text-3xl font-extrabold text-white tracking-tight">Create Identity</h1>
                <p className="text-slate-400 text-sm font-medium">Join the next generation of chat</p>
              </div>
            </div>
        ...
        <div className="hidden lg:flex flex-col items-center justify-center bg-indigo-600/5 p-16 space-y-12 relative overflow-hidden text-center">
          ...
          <div className="space-y-3 relative z-10">
            <h2 className="text-4xl font-black text-white leading-tight">Start Your <br /> Global Conversation.</h2>
            <p className="text-slate-400 text-lg font-medium">Join thousands of users sharing moments in real-time.</p>
          </div>
        </div>
      </div>
    </div>
